...
export default function AyudaPage() {
  ...
  const secciones: [string, string, ReactNode][] = [
    ...
    ['llave', 'Solicitar acceso', <>Pide unirte a un <strong>grupo privado</strong> o acceder a una <strong>sección</strong> (Logística, Verificación, producción…). Un <strong>líder</strong> o la <strong>coordinación</strong> revisa tu solicitud; si la aprueba, quedas dentro y te avisamos.</>],
