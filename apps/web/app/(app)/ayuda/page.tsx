    ...
    <RevelarScroll>
      ...
      {f.gestionCasos && !f.verificacion && (
        <S icono="documento" titulo="Gestión de solicitudes (tu función)">
          ...
          <li><strong>Los ítems se corrigen.</strong> Si te equivocaste o la necesidad cambió, edítalos: Verificación y Logística también pueden. Cada cambio queda <strong>registrado</strong> con quién lo hizo, cuándo y qué decía antes, así que corregir no es problema — es lo esperado.</li>
